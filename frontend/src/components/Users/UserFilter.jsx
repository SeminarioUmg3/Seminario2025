...
import { FaPlus, FaSearch, FaFilter, FaUsers, FaUserCog } from "react-icons/fa"
      ...
      <Row className="g-3 align-items-end">
        ...
        <Col xs={12} md={4} lg={3}>
          <Form.Group>
            ...
            >
              <FaFilter style={{ color: "var(--color-bin-blue)" }} />
              Filtrar por Rol
            </Form.Label>
            <Form.Select
              value={filtroRol}
        ...
        <Col xs={12} md={12} lg={5}>
          <div className="d-flex gap-2 justify-content-md-end">
            <OverlayTrigger
              placement="top"
              overlay={<Tooltip id="add-user-tooltip">Crear nuevo usuario</Tooltip>}
            >
              <Button
                variant="success"
